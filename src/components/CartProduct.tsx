...
const CartProduct = ({ item }: cartProductsProps) => {
  ...
  return (
    <div className="bg-gray-100 rounded-lg flex flex-col md:flex-row items-center gap-4 py-4 px-4  ">
      <Image
      ...
      <div className="flex items-center px-2 gap-4">
        <div className="flex flex-col gap-1 pl-3">
          ...
          <p className="lg:hidden text-sm text-gray-600 ">
          ...
          <p className="text-sm text-gray-600">
            Unit Price
            <span className="font-medium text-amazon_blue">
        ...
        <div className="font-md text-amazon_blue">
